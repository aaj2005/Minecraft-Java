...
public class WeirdMobModel extends EntityModel<WeirdMobEntity> {
    ...
    @Override
    public void setRotationAngles(WeirdMobEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale){
